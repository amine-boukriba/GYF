 ...
 * @author omarb
 */
public class RestoTemplateController implements Initializable {
    ...
    @FXML
    private JFXButton afficheResto;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     try {
                 ...
                 fxmlLoader.setLocation(getClass().getResource("AfficheRestaurantClient.fxml"));
    ...
    private void gotoRestoAjoutReservation( ) {
          view.getChildren().clear();
         AjoutReservation.setOnMouseClicked(event -> {
             try {
                 FXMLLoader fxmlLoader = new FXMLLoader();
                 fxmlLoader.setLocation(getClass().getResource("AjoutReservationRestaurant.fxml"));
                 AnchorPane anchorPane = fxmlLoader.load();
                 view.getChildren().add(anchorPane);
             } catch (IOException ex) {
                 Logger.getLogger(TemplateController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void gotoAffiche( ) {
          view.getChildren().clear();
         afficheResto.setOnMouseClicked(event -> {
             try {
                 FXMLLoader fxmlLoader = new FXMLLoader();
                 fxmlLoader.setLocation(getClass().getResource("AfficheRestaurantClient.fxml"));
                 AnchorPane anchorPane = fxmlLoader.load();
    ...
    private void listReservation( ) {
         ...
         AfficheReservation.setOnMouseClicked(event -> {
             try {
                 FXMLLoader fxmlLoader = new FXMLLoader();
                 fxmlLoader.setLocation(getClass().getResource("AfficheReservationRestoClient.fxml"));
                 AnchorPane anchorPane = fxmlLoader.load();
                 view.getChildren().add(anchorPane);
             } catch (IOException ex) {
                 Logger.getLogger(TemplateController.class.getName()).log(Level.SEVERE, null, ex);
