 ...
 * @author akram
 */
public class DetailsReservationMonController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ServiceMonuments serM=new ServiceMonuments();
        Monuments mon=serM.getMonumentsById(m.getId_esp());
        lbNom.setText(mon.getNom_monument());
        lbDesc.setText(mon.getDescription());
        lbLocalisation.setText(mon.getLocalisation());
        lbPays.setText(mon.getPays());
        filename.setText(mon.getImage_monument());
